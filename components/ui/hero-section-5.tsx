...
import { Menu, X, ChevronRight, Server, Code2, Target, Cloud, Database, Cpu, Monitor, Aperture } from 'lucide-react'
...
export function HeroSection() {
    return (
        <>
            {/* <HeroHeader /> */}
            <main className="overflow-x-hidden bg-black text-white min-h-screen relative flex flex-col justify-between">
                <section className="flex-1 flex items-center">
                    <div className="pt-28 pb-10 sm:pt-32 sm:pb-12 md:pb-16 lg:pb-20 lg:pt-44 w-full">
                        <div className="relative z-10 mx-auto flex max-w-7xl flex-col px-5 sm:px-8 lg:block lg:px-12">
                            <div className="mx-auto max-w-sm sm:max-w-lg text-center lg:ml-0 lg:max-w-full lg:text-left">
                                <h1 className="drop-shadow-2xl mt-4 max-w-2xl text-balance text-[2.6rem] sm:text-5xl md:text-6xl lg:mt-8 xl:text-[5.5rem] font-black uppercase tracking-tighter leading-[0.88]" style={{ color: "#ffffff" }}>
                                    Build 10x <br/>
                                    <span className="gradient-text-violet font-black">Faster</span> with GenZ
                                </h1>
                                <p className="mt-5 sm:mt-8 max-w-xs sm:max-w-2xl text-balance text-[10px] sm:text-[11px] drop-shadow-lg font-mono tracking-[0.2em] sm:tracking-[0.35em] uppercase leading-relaxed mx-auto lg:mx-0" style={{ color: "rgba(255,255,255,0.85)" }}>Premium photography, cinematic video production, and high-end editorial editing.</p>

                                <div className="mt-8 sm:mt-12 flex items-center justify-center gap-4 lg:justify-start">
                                    <Button
                                        asChild
                                        size="lg"
                                        variant="ghost"
                                        className="w-full sm:w-auto h-12 sm:h-14 rounded-full px-6 sm:px-8 text-[11px] hover:bg-white/10 font-mono uppercase tracking-[0.2em] border border-white/20 text-white">
                                        <Link href="/#contact" scroll={true}>
                                            <span className="text-nowrap">Request the Work</span>
                        ...
                        <div className="absolute inset-0 w-full h-full overflow-hidden opacity-50 pointer-events-none z-0">
                            <video
                                autoPlay
                                loop
                                muted
                                ...
                                src="/herobackgroundvideo.mp4"></video>
                        </div>
                    </div>
                </section>

                <div className="relative z-10 w-full pb-6">
                    <MovingBanner transparent={true} />
                </div>
            </main>
        </>
    )
